...
import { ScrollControls, Scroll, Text, Environment, Float, useScroll } from "@react-three/drei";
...
function BackgroundController() {
  ...
  useFrame((state) => {
    ...
    const colorA = new THREE.Color("#f0f9ff"); 
    const colorB = new THREE.Color("#dbeafe"); 
...
export default function PageScene({ children, title, pages = 4 }: PageSceneProps) {
  return (
    <div className="h-screen w-full bg-[#f0f9ff] overflow-hidden fixed inset-0 z-0">
          ...
          <ScrollControls pages={pages} damping={0.3}>
            ...
            <Scroll>
              ...
              <Float speed={2} rotationIntensity={0.2} floatIntensity={1}>
                <Text position={[0, 0, -15]} fontSize={10} color="#1e293b" textAlign="center" maxWidth={30}>
                  {title.toUpperCase()}
