    ...
    <div className="min-h-screen bg-brand text-brand">
      ...
      <main>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={reveal} transition={{ duration: 0.5 }} className="px-4 py-16 md:px-6">
          <div className="mx-auto max-w-6xl rounded-3xl border border-brand card-soft p-8 md:p-12">
          ...
          <div className="mx-auto max-w-7xl">
            ...
            <div className="mt-8 grid gap-6 md:grid-cols-3">
              {[
                ...
                <motion.article whileHover={{ y: -5 }} key={value.title} className={`rounded-2xl border p-8 ${i % 2 === 0 ? 'border-brand card-soft' : 'border-brand card-soft'}`}>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={reveal} transition={{ duration: 0.5 }} className="px-4 py-16 md:px-6">
          <div className="mx-auto max-w-4xl rounded-3xl border border-brand card-soft p-8 md:p-12">
            ...
            <div className="mt-6 flex flex-col items-center gap-8 md:flex-row">
              <div className="h-24 w-24 overflow-hidden rounded-full border border-brand bg-white shadow-sm">
                <img
                  src="/images/ceo.jpg"
                  alt="Dhiraj Yadav"
              ...
              <div>
                ...
                <a href="https://wa.me/917052207833" target="_blank" rel="noopener noreferrer" className="mt-6 inline-flex rounded-xl btn-brand px-6 py-3 font-semibold text-white transition hover:bg-orange-600">WhatsApp Us</a>
              </div>
            </div>
          </div>
        </motion.section>
        ...
        <motion.section initial="hidden" whileInView="visible" viewport={{ once: true }} variants={reveal} transition={{ duration: 0.5 }} className="px-4 pb-20 pt-10 text-center md:px-6">
          ...
          <a href="/contact" className="mt-8 inline-flex rounded-xl btn-brand px-8 py-4 font-semibold text-white transition hover:bg-orange-600">Get In Touch</a>
        </motion.section>
      </main>
      <Footer />
    </div>
