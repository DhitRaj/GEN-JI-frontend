          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full max-w-7xl">
            {insights.map((insight, idx) => (
              <GlassCard key={idx} className="text-center">
                <div className="text-6xl font-black text-slate-900 mb-2 tracking-tighter">{insight.value}</div>
                <h4 className="text-xl font-bold text-slate-800 mb-2 uppercase">{insight.title}</h4>
